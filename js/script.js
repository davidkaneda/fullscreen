$(function() {
    ...
    var BlurBGImage = (function() {
        ...
        $bxLoading          = $bxWrapper.find('div.bx-loading').hide(),
        ...
        $thumbsContainer = $bxWrapper.find('.bx-thumbs'),
        // the thumb elements
        ...
        init                = function() {
            ...
            $bxImgs.each( function(i) {
                var $bximg  = $(this),
                    str = "" + (i + 1),
                    pad = "00",
                    inc = pad.substring(0, pad.length - str.length) + str;
                    
                // save the position of the image in data-pos
                $('<img data-pos="' + $bximg.index() + '"/>').load(function() {

                    thumb = $('<a href="#" style="background-image:url(images/hi-res/'+inc+'.jpg)"></a>').appendTo($thumbsContainer);
        ...
        centerImageCanvas   = function() {
            ...
            $bxImgs.each( function(i) {
                ...
                if ( supportCanvas ) $currCanvas.css( styleCSS );
                        
                if ( i === current ) $bximg.show();
