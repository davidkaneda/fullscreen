...
$(function() {
                ...
                var BlurBGImage	= (function() {
                    ...
                    init				= function() {
                        ...
                        var thumbsContainer = document.getElementsByClassName('bx-thumbs')[0];

                        function appendThumb(i, inc) {
                            (function(i, inc) {
                                setTimeout(function() {
                                    var html = '<a href="#" style="background-image:url(images/hi-res/'+inc+'.jpg)"></a>';
                        ...
                        /*setTimeout(function() {
                            $bxImgs.each(function(i) {
                                ...
                                //$('.bx-thumbs').append('<a href="#" style="background-image:url(images/hi-res/'+inc+'.jpg)"></a>');
                            });
                        }, 0);*/
                        ...
                        $bxImgs.each( function(i) {
                            ...
                            var str = "" + (i + 1)
                            var pad = "00"
                            var inc = pad.substring(0, pad.length - str.length) + str;
